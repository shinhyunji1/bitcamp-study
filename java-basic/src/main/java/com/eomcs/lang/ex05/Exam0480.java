...
public class Exam0480 {
  public static void main(String[] args) {
    ...
    System.out.println((menu1 & LOGOUT) > 0); // 로그아웃인 경우 메뉴 1을 사용할 수 있냐
    // 계산 원리
    //   menu1: 00000001
    //  LOGOUT: 00000001
    //         &--------
    ...
    System.out.println((menu1 & GENERAL) > 0); // 로그아웃인 경우 메뉴 1을 사용할 수 있냐
    // 계산 원리
    //   menu1: 00000001
    // GENERAL: 00000010
    //         &--------
    ...
    System.out.println((menu1 & ADMIN) > 0); // 로그아웃인 경우 메뉴 1을 사용할 수 있냐
    // 계산 원리
    //   menu1: 00000001 세 번째 비트가 1이 아니다.
    //   ADMIN: 00000100
    //         &--------
    //          00000000 <--0 보다 큰 값이 나온다.
    // 해설 : 어떤 값에 대해 ADMIN 값을 & 한다는 것은
    // ADMIN 비트(오른쪽에서 세 번째 비트)가 1인지 검사한다는 뜻이다.
  }
}
